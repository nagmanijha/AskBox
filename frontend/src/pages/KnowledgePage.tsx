        ...
        <div className="p-8 text-skin-base transition-colors duration-300">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-skin-muted">{isAdmin ? 'Upload and manage RAG documents for AskBox AI responses' : 'Search and browse trusted regional knowledge'}</p>
                </div>
            ...
            {/* Upload Area — restricted to admin */}
            {isAdmin && (
                <div
                                    ...
                                    {!isAdmin && (
                                        <button
                                            className={`px-3 py-1 rounded-lg text-[10px] font-bold border ${
                                                isModern ? 'bg-slate-50 border-slate-200 text-slate-500' : 'bg-white/5 border-white/10 text-slate-400'
                                            }`}
                                        >
                                            View Content
                                        </button>
