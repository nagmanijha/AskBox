            ...
            <header className={`flex items-center justify-between px-6 h-16 shrink-0 transition-colors duration-300 ${isModern
                ...
                <div className="flex items-center gap-4 md:w-64">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className={`text-xl font-extrabold tracking-tight ${isModern ? 'text-gray-900' : 'text-slate-100'}`}>JanVani AI</h2>
                    </div>
                </div>
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                >
                    <div className="flex-1 space-y-2 py-4">
                        {navItems
                            .filter(item => {
                                // RBAC Rule: Only Admin can see Knowledge Base
                                if (item.path === '/knowledge') return user?.role === 'admin';
                                return true;
                            })
                            .map((item) => {
