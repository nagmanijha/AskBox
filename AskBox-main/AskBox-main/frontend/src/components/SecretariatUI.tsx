...
export type SectionType = 'farmers' | 'ladies' | 'students' | 'seniors';
...
export const CHIPS: Record<SectionType, Array<{ label: string; icon: string; color: string }>> = {
    farmers: [
...
export const NEWS: Record<SectionType, Array<{ headline: string; source: string }>> = {
    farmers: [
...
export const EXTRA_SCHEMES: Record<SectionType, any[]> = {
    farmers: [
...
export const ROADMAPS: Record<SectionType, { title: string; desc: string; status: string; summaryIcon: string; summaryLabel: string; summaryTitle: string; summaryValueLabel: string; summaryValue: string; steps: Step[] }> = {
    farmers: {
...
export function WeatherPanel({ themeColor }: { themeColor: string }) {
    return (
...
export function RoadmapSection({ section, themeColor, onOpenAI }: { section: SectionType; themeColor: string; onOpenAI: () => void }) {
...
export function NewsSection({ section, themeColor, lightThemeColor }: { section: SectionType; themeColor: string; lightThemeColor: string }) {
            ...
            <div className="bg-surface text-on-surface antialiased pb-32 font-body min-h-screen transition-colors duration-300 max-w-[420px] mx-auto relative shadow-2xl border-x border-outline-variant/10">
                    ...
                    <div className="fixed inset-0 z-[200] flex animate-in fade-in duration-300">
                        ...
                        <div className="relative w-72 bg-surface-container-lowest h-full shadow-2xl flex flex-col p-6 animate-in slide-in-from-left duration-500">
                            <div className="flex items-center justify-between mb-10">
                                <h2 className="text-xl font-bold text-primary font-headline">JanVani AI</h2>
                ...
                <header className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[420px] z-40 bg-surface/80 backdrop-blur-md flex items-center justify-between px-6 h-16 border-b border-outline-variant/20">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className={`text-xl font-bold ${data.themeColor.replace('bg-', 'text-')} font-headline tracking-tight transition-colors duration-500`}>JanVani AI</h1>
                    </div>
                    ...
                    <header className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[420px] z-50 bg-white/80 backdrop-blur-md shadow-sm flex items-center justify-between px-4 py-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[10px] text-on-surface-variant font-bold tracking-widest uppercase">Digital JanVani AI</span>
                            </div>
                        </div>
                        <div className="flex items-center gap-2">
