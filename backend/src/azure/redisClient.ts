...
class RedisService {
    ...
    async initialize(): Promise<void> {
        ...
        try {
            ...
            // Handle connection errors specifically to prevent unhandled rejection crashes
            this.client.on('error', (err: any) => {
                // Only log if we haven't already marked as disconnected/failed to avoid spam
                if (this.connected) {
